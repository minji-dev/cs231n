...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        num_colors, height, width = input_dim
        self.H = hidden_dim
        self.C = num_classes
    ...
    def loss(self, X, y=None):
        ...
        dLayer2, grads['W3'], grads['b3'] = affine_backward(softmax_dx, cache3)
        dLayer1, grads['W2'], grads['b2'] = affine_relu_backward(dLayer2, cache2)
        dLayer,  grads['W1'], grads['b1'] = conv_relu_pool_backward(dLayer1, cache1)
